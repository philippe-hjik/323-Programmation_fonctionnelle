...
namespace ConsoleApp2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            document.LoadFromFile(@"C:\Users\pf25xeu\Documents\GitHub\323-Programmation_fonctionnelle\personnel\marché\Place du marché.xlsx");

            Worksheet worksheet = document.Workbook.Worksheets.ByName("Produits");
            ...
            List<Product> products = new List<Product>
{
    ...
    new Product { Location = 15, Producer = "Crizzi", ProductName = "Groseilles", Quantity = 12,Unit = "kg", PricePerUnit = 5.50 }
            ...
            List<Product> test = (from p in products where p.Location == 1 select p).ToList();
